...
uint8_t SSD1306_Init(void) {
	...
	SSD1306_WRITECOMMAND(0x00); //---set low column address (page 34/65)
	SSD1306_WRITECOMMAND(0x10); //---set high column address (page 34/65)
	SSD1306_WRITECOMMAND(0x40); //--set start line address (40-7F)
	SSD1306_WRITECOMMAND(0x81); //--set contrast control register (do tuong phan)
	SSD1306_WRITECOMMAND(0x7F); // gia tri do tuong phan
	SSD1306_WRITECOMMAND(0xA1); //--set segment re-map 0 to 127
	SSD1306_WRITECOMMAND(0xA6); //--set normal display (1 -> pixel on, 0 -> pixel off)
