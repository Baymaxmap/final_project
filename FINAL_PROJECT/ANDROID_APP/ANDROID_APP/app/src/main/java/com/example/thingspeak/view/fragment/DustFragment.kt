...
class DustFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lineChart = view.findViewById(R.id.lineChartDust) // Kết nối LineChart từ giao diện
    ...
    private fun updateChart(dataList: List<ThingSpeakData>) {
        ...
        val entries = dataList.mapIndexed { index, data ->
            ...
            val yValue = data.field4?.toFloat() ?: 0f
            Entry(xValue, yValue)
        }

        // Cài đặt LineDataSet để tùy chỉnh giao diện biểu đồ
        val dataSet = LineDataSet(entries, "Fine Dust").apply {
